...
public class PlayerService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        BaseMusicItem results = PlayerManager.getInstance().getCurrentPlayingMusic();
        if (results == null) {
            stopSelf();
    ...
    private void createNotification(BaseMusicItem baseMusicItem) {
        try {
            String title = baseMusicItem.getTitle();
            BaseAlbumItem baseAlbumItem = PlayerManager.getInstance().getAlbum();
            String summary = baseAlbumItem.getSummary();
            ...
            String coverPath = Configs.MUSIC_DOWNLOAD_PATH + baseMusicItem.getMusicId() + ".jpg";
            ...
            if (bitmap != null) {
                ...
                PlayerManager.getInstance().requestAlbumCover(baseMusicItem.getCoverImg(), baseMusicItem.getMusicId());
